...
RSpec.describe PullRequests::Badge do
  it "renders the merged state" do
    result = render_component(PullRequests::Badge, state: :merged, is_draft: false)
  ...
  it "renders the closed state" do
    result = render_component(PullRequests::Badge, state: :closed, is_draft: false)
  ...
  it "renders the closed draft state" do
    result = render_component(PullRequests::Badge, state: :closed, is_draft: true)
  ...
  it "renders the open state" do
    result = render_component(PullRequests::Badge, state: :open, is_draft: false)
  ...
  it "renders the draft state" do
    result = render_component(PullRequests::Badge, state: :open, is_draft: true)
